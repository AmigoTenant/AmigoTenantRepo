...
{
    public class RegisterHouseFeatureCommandHandler : IAsyncCommandHandler<RegisterHouseFeatureCommand>
    {
        ...
        public RegisterHouseFeatureCommandHandler(
            IBus bus,
            IMapper mapper,
        ...
        public async Task<CommandResult> Handle(RegisterHouseFeatureCommand message)
        {
            HouseFeature entity = _mapper.Map<RegisterHouseFeatureCommand, HouseFeature>(message);
