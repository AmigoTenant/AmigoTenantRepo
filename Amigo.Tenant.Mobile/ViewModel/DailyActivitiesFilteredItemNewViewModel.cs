...
{
    public class DailyActivitiesFilteredItemNewViewModel : TodayViewModel
    {
        ...
        public DailyActivitiesFilteredItemNewViewModel(INavigator navigator,
        ...
        public override async void OnPushed()
        {
            ...
            HeaderTimeMsg = LabelTime;
            TextTodayDate = CurrentTime;
        }
        ...
        private async Task LoadData()
        {
            ...
            if (lstMoves != null && lstMoves.Any()) { move = lstMoves.First(); }
            else if (lstServices != null && lstServices.Any()) { service = lstServices.First(); }
            else if (lstDetentions != null && lstDetentions.Any()) { detention = lstDetentions.First(); }
            else if (lstTaylorLift != null && lstTaylorLift.Any()) { operateTaylorLift = lstTaylorLift.First(); }
            ...
            if (move != null)
            {
                ...
                EquipmentNumber = move.EquipmentNumber ?? string.Empty;
