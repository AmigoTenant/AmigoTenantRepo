...
{
    public partial class StartOperateTaylorLiftView : IPersistentView
    {
        public StartOperateTaylorLiftView()
        {
            InitializeComponent();
        ...
        public StartOperateTaylorLiftViewModel ViewModel => BindingContext as StartOperateTaylorLiftViewModel;
        ...
        private readonly IDictionary<string, Action<StartOperateTaylorLiftViewModel>> _actionMenu = new Dictionary<string, Action<StartOperateTaylorLiftViewModel>>()
        {
