...
{
    public partial class RegisterOperateTaylorLiftView : IPersistentView
    {
        public RegisterOperateTaylorLiftView()
        {
            InitializeComponent();
            InitCalendar();
            CleanControls();
...
#if DEBUG
        ~RegisterOperateTaylorLiftView()
        {
            System.Diagnostics.Debug.WriteLine("********* RegisterOperateTaylorLiftView is about to be destroyed *********");
        }
#endif
        public void Dispose()
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine(" ******** RegisterOperateTaylorLiftView Dispose() *********");
#endif
        }
        ...
        private void LoadListener()
        {
            ...
            //TxtCostCenter.TextChanged += TxtCostCenterOnTextChanged;
            ...
            //TxtFromBlock.TextChanged += TxtFromBlockOnSelectedIndexChanged;
            ...
            //TxtProduct.TextChanged += TxtProductTextChanged;
        ...
        private void TxtCostCenterOnTextChanged(object sender, TextChangedEventArgs e)
        {
            if (!string.IsNullOrEmpty(e.NewTextValue)) CleanLabel(LblCostCenter);
        }
        ...
        //}
        private void TxtFromBlockOnSelectedIndexChanged(object sender, TextChangedEventArgs e)
        {
            if (!string.IsNullOrEmpty(e.NewTextValue)) CleanLabel(LblFromBlock);
        }
        ...
        private void PkrEquipmentTypeOnSelectedIndexChanged(object sender, EventArgs eventArgs)
        {
            ...
            if (string.IsNullOrEmpty(dto.Code)) return;
            if (dto.Code.ToUpper().Contains(MoveCode.EquipmentType.TankCode))
            {
                //TxtDp25yrTestDate.Text = string.IsNullOrEmpty(TxtDp25yrTestDate.Text) ? string.Empty : TxtDp25yrTestDate.Text;
                ...
                //TxtDp5yrTestDate.Text = string.IsNullOrEmpty(TxtDp5yrTestDate.Text) ? string.Empty : TxtDp5yrTestDate.Text;
        ...
        private RegisterOperateTaylorLiftViewModel ViewModel => BindingContext as RegisterOperateTaylorLiftViewModel;
        ...
        private async System.Threading.Tasks.Task<bool> FieldValidator()
        {
            ...
            if (ViewModel.EquipmentNumberRequired == FieldRequirementCode.Value.Required)
            {
                ...
                {
                    ContainerValue = ViewModel.GeneralOperateTaylorLift.EquipmentNumber,
