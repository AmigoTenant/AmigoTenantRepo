...
{
    public partial class RegisterDetentionView : IPersistentView
    {
        public RegisterDetentionView()
        {
            InitializeComponent();
            InitCalendar();
            CleanControls();
...
#if DEBUG
        ~RegisterDetentionView()
        {
            System.Diagnostics.Debug.WriteLine("********* RegisterDetentionView is about to be destroyed *********");
        }
#endif
        public void Dispose()
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine(" ******** RegisterDetentionView Dispose() *********");
#endif
        }
        ...
        {
            Title = AppString.titleDetention;
        ...
        private RegisterDetentionViewModel ViewModel => BindingContext as RegisterDetentionViewModel;
        ...
        private async System.Threading.Tasks.Task<bool> FieldValidator()
        {
            ...
            if (ViewModel.EquipmentNumberRequired == FieldRequirementCode.Value.Required)
            {
                ...
                {
                    ContainerValue = ViewModel.GeneralDetention.EquipmentNumber,
