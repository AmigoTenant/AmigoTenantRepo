...
{
    public partial class StartDetentionView : IPersistentView
    {
        public StartDetentionView()
        {
            InitializeComponent();
        ...
        public StartDetentionViewModel ViewModel => BindingContext as StartDetentionViewModel;
        ...
        private readonly IDictionary<string, Action<StartDetentionViewModel>> _actionMenu = new Dictionary<string, Action<StartDetentionViewModel>>()
        {
