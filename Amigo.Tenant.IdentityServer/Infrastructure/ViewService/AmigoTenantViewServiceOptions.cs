...
namespace Amigo.Tenant.IdentityServer.Infrastructure.ViewService
{
    ...
    /// </summary>
    public class AmigoTenantViewServiceOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AmigoTenantViewServiceOptions"/> class.
        /// </summary>
        public AmigoTenantViewServiceOptions()
        {
