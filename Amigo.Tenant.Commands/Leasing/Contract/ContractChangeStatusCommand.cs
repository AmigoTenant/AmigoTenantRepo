...
{
    public class ContractChangeStatusCommand : AuditBaseCommand, IAsyncRequest<CommandResult>
    {
        ...
        public virtual List<PaymentPeriodRegisterCommand> PaymentsPeriod { get; set; }
